...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/22 20:42:09 by ysakahar          #+#    #+#             */
/*   Updated: 2023/02/25 23:30:31 by ysakahar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_fractal_options(void)
{
	...
	ft_putendl_fd("|                 ./fractol J 0.42 0.042             |", 1);
	ft_putendl_fd("+====================================================+\n", 1);
}
...
void	display_controls(void)
{
	...
	ft_putendl_fd("|   1, 2, 3, 4, 5, 6       |     Switch fractals     |", 1);
